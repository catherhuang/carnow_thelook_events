view: customers {
  ...
  # Address Info Group Grouped in the UI under: group_label
  dimension: address {
    type: string
    sql: ${TABLE}.address ;;
  ...
  # Date time dimension, represented via the dimension Group.
  # It should somewhere show the 'Registered Date" Label somewhere."
  ...
  # Hidden Dimensions below this Line
